...
- Runtime [Bun](https://bun.sh) (v1.0 o superior) — OCLoop se compila y ejecuta con Bun, así que debes instalarlo primero. Instálalo con:
...
1. Te pregunta qué quieres que OCLoop construya (el objetivo puede ser multilínea — termina con una línea que contenga solo `.`, o pulsa Ctrl-D).
...
3. Te muestra el plan propuesto y pregunta si **guardar**, **guardar y ejecutar** (guarda y arranca el loop de inmediato, como `ocloop -r`), **editar** (refinar con feedback) o **cancelar**.
